...
2. Replace most tuple-record usages without having to update anything but the declaration.
  This includes:
...
1. Compatibility across versions should be the same as if a field was added
   to the record.
2. Allow variable key lookup
3. Allow variable record name
